...
public:
  ...
  json dumpJson();
  /** Unload used resources. Typically unloads used Textures by calling raylib's
   * UnloadTexture */
  void unload() const;
  ...
  /** Add the Player into this Room. A unique_ptr is passed whose ownership will
   * be moved into the Room.
   * @param newPlayer A pointer to the player that will be moved into this Room.
   */
