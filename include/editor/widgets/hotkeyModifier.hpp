...
class HotkeyModifier : public tgui::SubwidgetContainer {
  ...
  public:
	...
	HotkeyModifier(const char *typeName = "FileChooser",
	...
	void setKey(const std::string &id, KeyboardKey key, bool isShift,
				bool isCtrl, bool isAlt, bool isSuper, bool override = false);
