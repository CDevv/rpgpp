...
EmptyFileView::EmptyFileView() {
	...
	bindTranslation(noticeText, "screen.project.emptyview.notice", &tgui::Label::setText);
...
void EmptyFileView::init(tgui::Group::Ptr layout, VariantWrapper *variant) { addWidgets(layout); }
