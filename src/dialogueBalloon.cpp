...
DialogueBalloon::DialogueBalloon(Rectangle rect) {
  ...
  this->text = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec "
...
void DialogueBalloon::draw() {
  if (active) {
    ...
    NPatchInfo info = NPatchInfo{
        Rectangle{0, 0, static_cast<float>(uiTexture.width),
    ...
    for (int i = 0; i < charIndex; i++) {
      ...
      Vector2 newMeasure =
          MeasureTextEx(font, TextSubtext(text.c_str(), i, 1), 13 * 3, 1.0f);
